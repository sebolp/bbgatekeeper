...
$lang = array_merge($lang, [
	...
	'BBGATEKEEPER_GROUP_DEPTH' => 'Raggruppa a',
	'BBGATEKEEPER_GROUP_16BIT' => 'IPv4 /16 bit · IPv6 /32 bit',
	'BBGATEKEEPER_GROUP_24BIT' => 'IPv4 /24 bit · IPv6 /48 bit',
	/* >=1.2.8 */
	'BBGATEKEEPER_PERC_PASSED' => 'Passati',
	'BBGATEKEEPER_PERC_BLOCKED' => 'Bloccati',
	/* >=1.2.8 */
	'LOG_BBGATEKEEPER_DEPLOY_FAILED'		=> '<strong>Deployment Bad Bot Gatekeeper fallito:</strong><br />» %1$s',
	'LOG_BBGATEKEEPER_PACKAGE_FAILED'		=> '<strong>Generazione del pacchetto di fallback Bad Bot Gatekeeper fallita:</strong><br />» %1$s',
	'BBGATEKEEPER_PACKAGE_FAILED'			=> 'Impossibile generare il pacchetto di deploy manuale (estensione php-zip mancante o file template non leggibili). Controlla il log admin per i dettagli.',
	'BBGATEKEEPER_DOWNLOAD_PACKAGE'		=> 'Scarica pacchetto di deploy manuale (.zip)',
	'BBGATEKEEPER_DOWNLOAD_PACKAGE_HINT'	=> 'Puoi scaricare uno zip pronto da caricare con i 3 file dal riquadro "Stato del deployment" qui sotto.',
	'BBGATEKEEPER_DOWNLOAD_PACKAGE_EXPLAIN'	=> 'Il deployment non è ancora completamente attivo su questo server. Se il salvataggio diretto continua a fallire (es. store/ o la document root non sono scrivibili da PHP), puoi scaricare un pacchetto pronto da caricare e posizionare i file manualmente via FTP/SFTP.',
	'BBGATEKEEPER_DOWNLOAD_PACKAGE_WARNING'	=> 'Attenzione: il pacchetto include un file .user.ini. Se sul tuo server esiste già un .user.ini nella root del sito, NON sostituirlo - apri il file esistente e aggiungi (o aggiorna) manualmente solo la riga "auto_prepend_file", lasciando invariate tutte le altre righe.',
	'BBGATEKEEPER_DOWNLOAD_MODAL_CONFIRM' => 'Scarica. Ho letto e compreso.',
	'BBGATEKEEPER_DOWNLOAD_MODAL_TITLE' => 'Download dei file',
	'BBGATEKEEPER_DOWNLOAD_MODAL_TEXT' => 'Stai scaricando 3 file. Usa questo metodo solo se il deploy automatico non va a buon fine.<br />Per garantire la corretta installazione devi leggere il file readme.txt all\'interno del file .zip scaricato.<br />- ATTENZIONE: i file devono essere caricati in percorsi differenti.<br>- ESTREMAMENTE IMPORTANTE: Devi verificare se possiedi già un file .user.ini nel percorso radice del tuo sito web (non solo nel percorso del forum, ma nell\'intero percorso del dominio). Non devi sovrascriverlo se ne hai già uno, ma dovrai scaricarlo, fare un backup, aggiornarlo e ricaricarlo nella stessa posizione. Leggi le istruzioni.',
]);
